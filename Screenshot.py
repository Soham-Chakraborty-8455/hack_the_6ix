...
while (True):
    ...
    if (len(idList) != 0):
        ...
        length = math.hypot(x6 - 1842 , y6 - 189)
        # hypot will give the length of the hypotenuse line
        length1 = math.hypot(x2 - 1842 , y2 - 189)

        length2 = math.hypot(x4 - 1842 , y4 - 189)

        print(length)
        if(length > 1300 and (idList[4][1] > idList[2][1]  and idList[20][2] > idList[17][2])):
